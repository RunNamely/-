...
//		System.out.println("ProductOrder_update------------" + productOrderService.getProductOrder(productOrder));
	...
	public ModelAndView postProductOrder(ProductOrder productOrder, HttpSession session) {
//		System.out.println("postProductOrder============" + productOrder);
		Integer userId = (int) session.getAttribute("userId");
		productOrder.setCreateUserid(userId);
		productOrder.setOrderSource(userId);
...
//		System.out.println("deleteProductOrder=======" + id);
	...
	public ModelAndView putProductOrder(ProductOrder productOrder, HttpSession session) {
//		System.out.println(productOrder);
		Integer userId = (int) session.getAttribute("userId");
		productOrder.setUpdateUserid(userId);
